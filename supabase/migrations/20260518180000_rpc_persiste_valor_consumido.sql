-- CREATE OR REPLACE da RPC aplicar_recepcao_nf pra também persistir
-- valor_consumido (vu real da NF) no INSERT final de recepcao_consumos.
-- A coluna foi adicionada em 20260518170000. A RPC anterior (150000)
-- calculava valor_consumido na temp _consumo_log mas não gravava.
--
-- Único delta vs versão 150000: INSERT INTO recepcao_consumos agora inclui
-- valor_consumido. Resto da RPC idêntico (transcrito aqui pra manter o
-- arquivo auto-suficiente).
...
BEGIN
  ...
  -- DIFERENÇA vs 150000: inclui valor_consumido (vu real da NF)
